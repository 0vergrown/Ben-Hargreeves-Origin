...
execute unless score $next tent.node_id = $NODE_COUNT tent.uuid positioned ^ ^ ^-1 summon marker run function ben_hargreeves:tentacles/_set_node_data_and_summon